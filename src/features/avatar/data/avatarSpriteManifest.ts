...
export type AvatarTopType = 'shirt' | 'hoodie' | 'jacket' | 'jersey';

export type AvatarBottomType = 'pants' | 'shorts' | 'cargo';

export type AvatarFootwearType = 'sneakers' | 'boots' | 'running';
...
export type AvatarConfig = {
  ...
  footwearType: AvatarFootwearType;
...
export const avatarHairAssets: Record<AvatarHairType, DirectionalAssets> = {
  spiky: {
...
export const avatarTopAssets: Record<AvatarTopType, DirectionalAssets> = {
  shirt: {
...
export const avatarBottomAssets: Record<AvatarBottomType, DirectionalAssets> = {
  pants: {
...
export const avatarFootwearAssets: Record<
  AvatarFootwearType,
  DirectionalAssets
> = {
  sneakers: {
